...
const _CONFIG = (
	{
		...
		EntrypointInputSourceFile: `${__dirname}/source/Fable-UUID-Browser-Shim.js`,
		...
		LibraryUniminifiedFileName: `fable-uuid.js`,

		// The name of the minified version of the packaged library, for production release:
		LibraryMinifiedFileName: `fable-uuid.min.js`
	});
